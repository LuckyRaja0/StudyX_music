...
import config
from StudyX import Carbon, YouTube, app
from StudyX.core.call import Study
from StudyX.misc import db
from StudyX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from StudyX.utils.exceptions import AssistantErr
from StudyX.utils.inline.play import (stream_markup, queue_markup,

                                          telegram_markup)
from StudyX.utils.inline.playlist import close_markup
from StudyX.utils.pastebin import Studybin
from StudyX.utils.stream.queue import put_queue, put_queue_index
from StudyX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Study.force_stop_stream(chat_id)
