...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"StudyX/assets/StudyX.png")
        ...
        font = ImageFont.truetype("StudyX/assets/font2.ttf", 45)
        ImageFont.truetype("StudyX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("StudyX/assets/font2.ttf", 30)
        ImageFont.truetype("StudyX/assets/font.ttf", 30)
