...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Study MUSIC")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/LuckyRaja0/StudyX_music",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/quizstudyupsc")
